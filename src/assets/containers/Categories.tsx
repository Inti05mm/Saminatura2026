...
/**
 * Mapea el nombre visible a la categoría que usa tu página /shopping?category=...
 * (ajusta los valores a tus categorías reales si difieren)
 */
...
export default function Categories() {
  ...
  return (
    <div className="w-full gris">
      {/* SVG SUPERIOR */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1440 320"
        className="w-full h-20 md:h-24 text-verde-1"
        preserveAspectRatio="none"
      >
        <path
          fill="currentColor"
          d="M0,320L24,320C48,320,96,320,144,282.7C192,245,240,171,288,160C336,149,384,203,432,208C480,213,528,171,576,176C624,181,672,235,720,218.7C768,203,816,117,864,85.3C912,53,960,75,1008,90.7C1056,107,1104,117,1152,138.7C1200,160,1248,192,1296,202.7C1344,213,1392,203,1416,197.3L1440,192L1440,320L0,320Z"
        />
      </svg>

      {/* CONTENIDO */}
      <section className="py-16 px-8 verde-1">
        <h2 className="text-3xl font-bold mb-8 text-center text-white">
          Descubre nuestras categorías
        </h2>

        <div className="flex gap-6 overflow-x-auto scrollbar-hide justify-start md:justify-center">
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  const q = toCategoryQuery(category.name)
                  navigate(`/shopping?category=${encodeURIComponent(q)}`)
                }}
                className="flex flex-col items-center flex-none focus:outline-none"
              >
                <div
                  className={`
                    ...
                    ${
                      isActive
                        ? "bg-fuchsia-950 text-white scale-110 shadow-lg"
                ...
                <span
                  className={`mt-3 text-sm font-medium ${
                    isActive ? "text-fuchsia-950" : "text-white"
                  }`}
                >
                  {category.name}
                </span>
