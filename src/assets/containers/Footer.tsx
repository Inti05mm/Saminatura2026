...
export default function Footer() {
  return (
    <footer className="bg-[#f7f3ea] px-6 py-10 text-black md:px-12">
      <div
        className="
      ...
      >
          ...
          <ul className="flex items-center gap-3">
            ...
            <li>
              <a
                ...
                className="
                  group inline-flex h-[50px] w-[50px]
        ...
        <div>
          ...
          <p className="text-sm leading-7">
            Email:{" "}
            <a
              href="mailto:saminatura202369@gmail.com"
